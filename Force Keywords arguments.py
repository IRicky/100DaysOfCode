"""
Write a function called get_profile that can only allows 2 keyword arguments:
name and profession which default to julian and programmer respectively.
...
print(get_profile(name='bob', profession='sof'))
